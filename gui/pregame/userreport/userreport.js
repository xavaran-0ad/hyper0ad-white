var g_IntervalReminderEnableFeedback = 2592000000; // ~ one month
...
{
	Engine.ConfigDB_CreateAndWriteValueToFile("user", "gui.userreport.visible", "false", "config/user.cfg");
	Engine.ConfigDB_CreateAndWriteValueToFile("user", "gui.userreport.dateMadeInvisible", String(Date.now()), "config/user.cfg");
	hideUserReport();
}
